...
export default function AllTasks() {
  ...
  return (
    <div className="w-full flex flex-col gap-8  overflow-y-scroll">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-semibold text-zinc-300">All Tasks</h1>
      ...
      <div className="flex items-center flex-wrap gap-4 h-full overflow-y-scroll container">
